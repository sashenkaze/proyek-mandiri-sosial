...
@section('content')
    <form class="w-75 d-block mx-auto my-5" method="POST" action="{{ route('signup.store') }}">
        ...
        <!-- Submit button -->
        <button data-mdb-ripple-init type="submit" class="btn btn-danger btn-block mb-4 btn-lg">Sign up</button>

        <!-- Register buttons -->
        <div class="text-center">
            <p>or sign up with:</p>
            <button data-mdb-ripple-init type="button" class="btn btn-danger btn-floating mx-1 btn-lg">
